...
import com.example.ss.ProductActivityPack.ReviewsAdapter;
...
public class MoreReviewsAdapter extends RecyclerView.Adapter<MoreReviewsAdapter.ViewHolder> {


    private List<ReviewModel> reviewsList;
    private Context context;

    public MoreReviewsAdapter(List<ReviewModel> reviewsList, Context context) {
    ...
    @NonNull
    @Override
    public MoreReviewsAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
